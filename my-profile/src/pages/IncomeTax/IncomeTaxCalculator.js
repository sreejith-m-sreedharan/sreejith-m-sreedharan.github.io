                ...
                <div className="form">
                    <form>
                        <table>
                            <tbody>
                                <tr>
                                    <td style={{'fontSize':'14px','textAlign':'left'}}>Age</td>
                                ...
                                <tr style={{"paddingTop":'10px'}}>
                                    ...
                                    <td style={{'textAlign':'right'}}><table width='100%'>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>From Interest Paid on Home Loan</td>
